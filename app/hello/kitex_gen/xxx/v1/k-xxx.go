...
func (p *XXXXXXArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_XXXXXXArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *XXXXXXArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *XXXXXXArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *XXXXXXArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "XXX_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *XXXXXXArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("XXX_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *XXXXXXArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *XXXXXXArgs) field1Length() int {
	l := 0
...
func (p *XXXXXXResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_XXXXXXResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *XXXXXXResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *XXXXXXResult) FastWrite(buf []byte) int {
	return 0
}

func (p *XXXXXXResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "XXX_result")
	if p != nil {
...
func (p *XXXXXXResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("XXX_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *XXXXXXResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *XXXXXXResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
...
func (p *XXXXXXArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *XXXXXXResult) GetResult() interface{} {
	return p.Success
}
